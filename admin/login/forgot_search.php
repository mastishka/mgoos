<?php
	...
	{
		$str_msg = sprintf("<BR/>Please answer following security question for e-mail ID <B>%s</B>.<BR/><BR/><FORM METHOD=POST ACTION=\"forgot_result.php\"><TABLE><TR><TD>Security Question :</TD><TD><B>%s</B><BR/></TD></TR><TR><TD>Security Answer :</TD><TD><INPUT TYPE=\"text\" NAME=\"ans\" SIZE=\"40\"/><INPUT TYPE=\"submit\" VALUE=\"Submit\"/></TD></TR></TABLE></FORM>",$email, $sec_ques);
	}
?>
...
<HTML xmlns="http://www.w3.org/1999/xhtml">
	...
	<BODY>
		<FIELDSET>
		<LEGEND>Welcome to MGooS forgot passord help</LEGEND>
