...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		?>
		<fieldset style="width:800px">
		<legend><A HREF="../index.php"><IMG SRC="../images/mgoos_logo_s.jpg" WIDTH="148" HEIGHT="46" BORDER="0" ALT="Go to home page"></A></legend>
		...
		<form id="LOGINFORM" name="LOGINFORM" method="POST" action="register-exec.php">
			<table width="800" border="0" align="center" cellpadding="2" cellspacing="0">
				<tr>
					...
					<td><input name="FNAME" type="text" class="textfield" id="FNAME" onblur ="CheckForEmpty(this);" size="30"/>&nbsp;&nbsp;<IMG ID="FNAME_CR" STYLE="display:none" SRC="../images/apply.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""><IMG ID="FNAME_WR" STYLE="display:none" SRC="../images/cancel.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""><BR/><BR/></td>
				</tr>
				<tr>
					<td><B>Last Name :</B><BR/><BR/></td>
					<td><input name="LNAME" type="text" class="textfield" id="LNAME" onblur ="CheckForEmpty(this);" size="30"/>&nbsp;&nbsp;<IMG ID="LNAME_CR" STYLE="display:none" SRC="../images/apply.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""><IMG ID="LNAME_WR" STYLE="display:none" SRC="../images/cancel.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""><BR/><BR/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input name="EMAIL" type="text" class="textfield" id="EMAIL" onblur ="ValidateEmail(this);" size="50"/>&nbsp;&nbsp;<IMG ID="EMAIL_CR" STYLE="display:none" SRC="../images/apply.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""><IMG ID="EMAIL_WR" STYLE="display:none" SRC="../images/cancel.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT=""><BR/><BR/></td>
				</tr>
				<tr>
				...
				<tr>
					<td><B>Confirm Password :</B><BR/><BR/></td>
				...
				<tr>
					<td><B>Security Question :</B><BR/><BR/></td>
					<td>
