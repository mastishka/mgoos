...
//include_once("../admin/database/config.php");
class CAdminManager
	{
		...
		public function __construct()
		{
			...
			$this->db_link_id_admin = mysql_connect(CConfig::HOST, CConfig::USER_NAME , CConfig::PASSWORD) or
				    die("Could not connect: " . mysql_error());
			mysql_select_db(CConfig::DB_ADMIN, $this->db_link_id_admin);
		}
